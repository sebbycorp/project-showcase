...
Current version: **0.18.0** (`manifest.json`). Pin the toolbar icon, then open the gear for **Settings** sub-tabs **Connect**, **Forward**, **Resources**, **Identity**, and **App**. If you already had an older build loaded, click **Reload** on this unpacked card.
